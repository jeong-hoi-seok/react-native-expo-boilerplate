...
- TypeScript · NativeWind · CVA · Zustand · Biome
...
스토어 배포용 빌드는 [EAS Build](https://docs.expo.dev/build/introduction/)를 씁니다.

## 문서

- `agent.md` — AI 작업 지침
- `docs/styling.md` — NativeWind · CVA · `cn` 스타일링
- `docs/init-setup.md` — 초기 설치 (Expo + NativeWind + Biome)
- `docs/naming-convention.md` — 네이밍
- `docs/commit-convention.md` — 커밋
- `docs/git-merge-request-guide.md` — MR/PR
